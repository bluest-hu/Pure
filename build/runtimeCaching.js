const runtimeCaching = [
    ...
    {
        urlPattern:
            /^(?:http|https):\/\/static.bluest.xyz\/(?:(?:[^?#]*)).(?:(?:jpg|jpeg|png|gif|webp|mp3|svg)(?:|\?(?:[^\/]*)))/g,
        handler: "CacheFirst",
        options: {
            fetchOptions: {
                mode: "no-cors",
    ...
    {
        urlPattern:
            /^(?:http|https):\/\/static.bluest.xyz\/(?:(?:[^?#]*)).(?:(?:js|css)(?:|\?(?:[^\/]*)))$/g,
        handler: "CacheFirst",
        options: {
            fetchOptions: {
                mode: "no-cors",
    ...
    {
        urlPattern:
            /^(?:http|https):\/\/asset.bluest.xyz\/(?:(?:[^?#]*)).(?:(?:jpg|jpeg|png|gif|webp|mp3|svg)(?:|\?(?:[^\/]*)))$/g,
        handler: "CacheFirst",
        options: {
            fetchOptions: {
                mode: "no-cors",
    ...
    {
        urlPattern:
            /^(?:http|https):\/\/asset.bluest.xyz\/(?:(?:[^?#]*)).(?:(?:js|css)(?:|\?(?:[^\/]*)))$/g,
        handler: "CacheFirst",
        options: {
            fetchOptions: {
                mode: "no-cors",
